...
## Running the script on the big intermediarz file that got made in an earlier run

Rscript scripts/05_make_PA_table.R GPS_Intermediate_BIG outputs/intermediate_blast_outputs_1.tsv
